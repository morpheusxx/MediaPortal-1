...
xcopy "TvService\bin\%TARGET%\x86\SQLite.Interop.dll" "_MP2SlimTV\%PKG%\references\x86\" /R /Y  || exit /b 15
xcopy "TvService\bin\%TARGET%\x64\SQLite.Interop.dll" "_MP2SlimTV\%PKG%\references\x64\" /R /Y  || exit /b 15
